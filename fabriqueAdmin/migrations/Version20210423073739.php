 ...
 */
final class Version20210423073739 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE absence (id INT AUTO_INCREMENT NOT NULL, promo_appre_id INT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, justifie VARCHAR(255) NOT NULL, INDEX IDX_765AE0C9401C2F22 (promo_appre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE apprenant (id INT NOT NULL, offres_id INT DEFAULT NULL, nom VARCHAR(400) NOT NULL, prenom VARCHAR(400) NOT NULL, tel VARCHAR(400) NOT NULL, date_naissance DATE NOT NULL, adresse VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, git VARCHAR(255) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_C4EB462E6C83CD9F (offres_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE contacts (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT DEFAULT NULL, nom VARCHAR(400) NOT NULL, prenom VARCHAR(400) NOT NULL, email VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, mobile VARCHAR(255) NOT NULL, INDEX IDX_33401573A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
